...
const PlaceOrder = () => {
  ...
  const {token,products,cartItems,setCartItems,getCartItems,getCartAmount,delivery_fee,backendUrl}=useContext(ShopContext)
  ...
  return (
    <form onSubmit={onSubmitHandler}  className='flex flex-col sm:flex-row justify-between gap-4 pt-5 sm:pt-14 min-h-[80vh]'>
      ...
      <div className='flex flex-col gap-4 w-full sm:max-w-[480px]'>
        ...
        <div className=' sm:text-2xl text-xl my-3'> 
      ...
      <div className='mt-8'>
       ...
       <div className='mt-12'>
        <div className='sm:text-2xl text-xl'>
         ...
         <button type='Submit' className='bg-black text-white my-8 px-8 py-3' >PLACE ORDER</button>
    </div>
