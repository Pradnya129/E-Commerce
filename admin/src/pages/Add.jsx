       ...
       <div>
        ...
        <div className='flex gap-2'>
          <label htmlFor="image1">
            ...
            <input onChange={(e)=>setImage1(e.target.files[0])}  valu type="file" id='image1'hidden  />
          </label>
          <label htmlFor="image2">
            <img src={!image2 ? assets.upload_area: URL.createObjectURL(image2)} alt=""className='w-20 '  />
            <input onChange={(e)=>setImage2(e.target.files[0])} valu type="file" id='image2'hidden  />
          </label>
          <label htmlFor="image3">
            <img src={!image3 ? assets.upload_area: URL.createObjectURL(image3)} alt="" className='w-20 ' />
            <input onChange={(e)=>setImage3(e.target.files[0])} valu type="file" id='image3'hidden  />
          </label>
          <label htmlFor="image4">
            <img src={!image4 ? assets.upload_area: URL.createObjectURL(image4)} alt=""className='w-20 '  />
            <input onChange={(e)=>setImage4(e.target.files[0])} valu type="file" id='image4'hidden  />
          </label>
        </div>
       </div>
       ...
       <div className='flex flex-col sm:flex-row gap-2 w-full  sm:gap-8'>
        ...
        <div>
         ...
         <div className='flex gap-2 mt-2'>
          <input type="checkbox" id='bestSeller' onClick={()=>setBestSeller(prev => !prev)} checked={bestSeller}  />
